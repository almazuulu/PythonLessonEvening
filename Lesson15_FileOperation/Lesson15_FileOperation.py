...
textUser = """Меня зовут Олег, мне 32 года
...
with open('someText.txt', 'r', encoding='utf8') as file4:
...
with open(fileName, 'w') as fileUser:
    fileUser.write('Name of User: %s \n Age of user %d ' % (name, age))
