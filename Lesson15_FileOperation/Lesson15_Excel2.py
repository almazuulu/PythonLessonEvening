...
#Запись формулы
wb3 = load_workbook('Student.xlsx')
sheetStudent = wb3.worksheets[0]

sheetStudent['A8'] = 'TotalAge'
sheetStudent['D8'] = '=SUM(D2:D7)'
sheetStudent['D9'] = '=(D8+10)'

wb3.save('Student.xlsx')

#wb4 = load_workbook('food.xlsx')
wb4 = open('food.xlsx', data_only=True)
sheet10 = wb4.worksheets[0]

print(sheet10['H10'].value)
